...
const links = [
  {
    label: 'Email',
    val: 'airagayleuy@gmail.com',
    href: 'mailto:airagayleuy@gmail.com',
    icon: (
  ...
  {
    label: 'GitHub',
    val: 'github.com/AiraGayle',
    href: 'https://github.com/AiraGayle',
    icon: (
  ...
  {
    label: 'LinkedIn',
    val: 'linkedin.com/in/aira-gayle-uy',
    href: 'https://linkedin.com/in/aira-gayle-uy',
    icon: (
